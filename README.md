...
> ⚠️ **Sobre el repo de skills de ejemplo:** míralo *después* de construir tu skill, no antes. En el directo queremos ver tu enfoque natural, no uno copiado de un ejemplo. Tu primer intento "en crudo" es justo lo que da valor a la comparación con SDD.

---

## Preguntas frecuentes

**¿Tengo que crear una skill compleja?**
No. Una skill sencilla pero bien acotada es mucho mejor que una compleja y vaga. Si dudas, simplifica.

**¿Puedo usar IA para crear la skill?**
Sí, pero anota en el diario qué partes generaste con ayuda de IA y qué partes decidiste tú. Eso será relevante en la discusión del directo.

**¿Y si mi skill no se activa cuando la pruebo?**
Anótalo en el diario como parte de la prueba. No la "arregles" después — queremos ver el resultado de tu primer intento. En el directo trabajaremos sobre por qué pasa eso y cómo lo aborda SDD.

**¿Qué repo uso en cada parte?**
Son dos distintos a propósito. **Parte A (auditoría):** idealmente un proyecto propio real, porque revela más huecos; el sandbox de S2 vale como alternativa. **Parte B (skill):** siempre el sandbox de S2, para no ensuciar tu repo real con una skill de prueba.

**¿Puedo auditar un repo del trabajo en la Parte A?**
Sí, es lo ideal. Pero en el entregable solo pones tus hallazgos (descripciones de qué no supo el agente), nunca código propietario ni secretos. La auditoría se queda en tu máquina.

**En la Parte A, ¿tengo que crear el archivo AGENTS.md con mis hallazgos?**
No. Solo los identificas y los anotas en el entregable. El archivo se construye en el directo — los hallazgos que traes son la materia prima para esa demo.

**¿Y si el agente acierta todo en la Parte A y no encuentro nada que no supiera?**
Poco probable, pero si pasa, es un hallazgo en sí mismo: significa que tu código es muy autoexplicativo o que el proyecto es pequeño. Anótalo y trae un ejemplo de algo que *un proyecto más grande* sí necesitaría decirle al agente.

**¿Dónde creo la skill, en el proyecto del bloque o en el sandbox?**
En el sandbox que creaste para la S2. El proyecto real del bloque lo tocaremos en el directo, no antes.

**Si mi sandbox de S2 no levanta, ¿debo seguir?**
Sí. La Parte A puede hacerse con cualquier repo (idealmente uno propio) y solo necesita leer código, no ejecutarlo. La Parte B construye la skill en el sandbox, pero tampoco necesita que el proyecto *corra* — solo crear un archivo dentro. Anota la incidencia del arranque y continúa; lo vemos al inicio del directo.

**¿Qué pasa si no llego a entregar dos días antes?**
La entrega fuera de plazo no se podrá incorporar a la dinámica del directo. Si prevés que no vas a llegar, avisa a tu TA cuanto antes para acordar cómo seguir.
